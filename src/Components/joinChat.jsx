...
function JoinChat({user,toggleButton}) {
  ...
  return (
    <div >
        {
            joinRoom ? <Chat user={user} roomid={room} toggleChat={toggleChat} roomName={roomName}/> :

            <div className=' flex justify-center items-start'>
            <div className="py-4 px-4 shadow-sm shadow-slate-400 rounded-md bg-black text-white border border-white !important">
